...
import { useIsMobile } from "@/shared/hooks/docs/use-mobile";
...
export default function EditorPage() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (e.key === "Delete") {
        const { selectedId, selectedType, removeField, removeTable } =
  ...
  const handleDownloadPdf = useCallback(() => {
    ...
    toast({
      title: "PDF скачан",
      description: "Файл сохранен на ваш компьютер",
    });
        ...
        <ResizablePanel defaultSize={40} minSize={25} maxSize={50}>
          <div className="h-full flex flex-col bg-muted/30">
            ...
            >
              ...
              <TabsContent
                value="properties"
                className="flex-1 m-0 p-3 overflow-auto"
              >
                <Inspector />
              </TabsContent>
