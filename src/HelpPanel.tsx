...
const helpSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Выберите элемент, затем потяните за синюю точку в правом нижнем углу элемента.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Выберите текстовый блок и передвиньте ползунок 'Размер шрифта' на панели свойств.",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "Выберите таблицу и нажмите кнопку '+ Строка' на панели свойств.",
      },
      {
        question: "Как добавить колонку?",
        answer:
          "Выберите таблицу и нажмите кнопку '+ Колонка' на панели свойств.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Выберите изображение и потяните за синюю точку в правом нижнем углу.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Нажмите кнопку со стрелкой влево (Отменить) на панели инструментов.",
      },
      {
        question: "Как вернуть отмененное действие?",
        answer:
          "Нажмите кнопку со стрелкой вправо (Вернуть) на панели инструментов.",
      },
      {
...
export function HelpPanel() {
  ...
  return (
    <Sheet open={showHelp} onOpenChange={setShowHelp}>
      <SheetContent className="w-full sm:max-w-lg" data-testid="help-panel">
        <SheetHeader>
